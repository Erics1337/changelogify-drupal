...
To run the automated tests for this module, ensure you have the development dependencies installed:
...
composer test:changelogify
```

Or manually via PHPUnit:

```bash
./vendor/bin/phpunit web/modules/custom/changelogify/tests/src/Unit
```
